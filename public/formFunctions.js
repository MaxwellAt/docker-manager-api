  ...
  sweetalert2.fire({
    ...
    didOpen: () => {
      ...
      downloadButton.addEventListener("click", async () => {
        const selectedMethod = sweetalert2.getPopup().querySelector("input[name=http-method]:checked").value;
        downloadButton.href = `${url}/script/?type=${testType.value}&id=${id}&method=${selectedMethod}`;
      });
